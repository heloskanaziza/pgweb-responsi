...
<body>
  ...
  <main>
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="fw-light">Detail Informasi Apotek Kabupaten Purworejo</h1>
        </div>
      </div>
    </section>
    ...
    <div class="text-center container">
      <?php include "apotek_tampilkan_data.php"; ?>
  </div>

    <div class="py-2 container">
      <a href="http://localhost/pgweb-responsi/bootstrap-5.3.2-examples/data/apotek_tambah_data.html" target="_blank"
